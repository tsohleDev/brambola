...
# 📖 Brambola <a name="about-project"></a>

> About this repository

**Math MAgicians** is a front end only web app created with React to give infomation about the forex market
...
```sh
git clone https://github.com/tsohleDev/brambola.git
```
...
- **[Create another page for stocks and change the home page]**
- **[Change the API to a free one]**
